...
heart = pd.read_csv("https://raw.githubusercontent.com/kushal140/datasets/main/heart_2020_cleaned.csv")
heart = heart.drop(columns=['HeartDisease'])
...
def result():
    ...
    print(prediction)
    if prediction == 1:
        results = "You  May Have Heart Disease Consult A Doctor"
    else:
        results = "Congratulations ! You Don't  Have  Heart Disease"
    return results
